...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'courses_live', (
            ...
            ('section', self.gf('django.db.models.fields.related.ForeignKey')(related_name='live_sessions', to=orm['courses.Section'])),
    ...
    models = {
        ...
        u'courses.live': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'section': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'live_sessions'", 'to': u"orm['courses.Section']"}),
            'slug': ('django_extensions.db.fields.AutoSlugField', [], {'allow_duplicates': 'False', 'max_length': '50', 'separator': "u'-'", 'blank': 'True', 'populate_from': "'title'", 'overwrite': 'True'}),
