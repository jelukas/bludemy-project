...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.active'
        db.add_column(u'courses_section', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Lesson.active'
        db.add_column(u'courses_lesson', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.active'
        db.delete_column(u'courses_section', 'active')

        # Deleting field 'Lesson.active'
        db.delete_column(u'courses_lesson', 'active')
