...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.position'
        db.add_column(u'courses_course', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Course.active'
        db.add_column(u'courses_course', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.position'
        db.delete_column(u'courses_course', 'position')

        # Deleting field 'Course.active'
        db.delete_column(u'courses_course', 'active')
