...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Lesson'
        db.create_table(u'courses_lesson', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=240)),
            ('slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, populate_from='title', overwrite=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=244, blank=True)),
            ('section', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lessons', to=orm['courses.Section'])),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'courses', ['Lesson'])

        # Adding M2M table for field user_completed_lessons on 'Lesson'
        m2m_table_name = db.shorten_name(u'courses_lesson_user_completed_lessons')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lesson', models.ForeignKey(orm[u'courses.lesson'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'courses_lesson')

        # Removing M2M table for field user_completed_lessons on 'Lesson'
        db.delete_table(db.shorten_name(u'courses_lesson_user_completed_lessons'))
